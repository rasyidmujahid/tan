...
background-color: rgba(255, 102, 0, 1); color: #fcfcfc
}
...
.wpb_accordion .wpb_accordion_wrapper .wpb_accordion_section .wpb_accordion_header, .vc_toggle_title  { border-color:rgba(255, 102, 0, 0.2);
}
article.sticky { box-shadow: inset 0 0 0px 1px rgba(255, 102, 0, 0.2) }
/* WooCommerce stars color */
.woocommerce .star-rating:before, .woocommerce-page .star-rating:before, .star-rating span:before { color:#008b8b;
}
