...
background-color: rgba(221, 99, 99, 1); color: #f4f4f4
}
...
background-color: rgba(221, 115, 115, 1) !important; 
color: #ffffff; 
...
.wpb_accordion .wpb_accordion_wrapper .wpb_accordion_section .wpb_accordion_header, .vc_toggle_title  { border-color:rgba(239, 239, 239, 0.4);
}
article.sticky { box-shadow: inset 0 0 0px 1px rgba(239, 239, 239, 0.4); 
}
...
/* FOOTER BACK COLOR  */
footer { 
background-color: rgba(58, 58, 58, 0.8); filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="#cc3a3a3a", endColorstr="#cc3a3a3a",GradientType=0 );  
}
