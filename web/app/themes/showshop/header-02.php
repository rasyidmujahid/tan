...
?>
	...
	<section class="main-section header-02">	
		...
		<header class="header-bar row head-element"  data-options="sticky_on: large" data-topbar >
			...
			<div id="site-menu" class="row horizontal head-element">
				
				<div class="left-button accent-1-light-40">
				...
				<div class="small-12 horizontal-menu-wrapper accent-2-a">
					<?php get_template_part('template_parts/header_horizontal_menu'); ?>
				</div>
