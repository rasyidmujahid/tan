...
<form action="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" method="post" class="track_order">
	...
	<div class="panel callout"><?php _e( 'To track your order please enter your Order ID in the box below and press return. This was given to you on your receipt and in the confirmation email you should have received.', 'woocommerce' ); ?></div>
	...
	<div><input type="submit" class="button tiny" name="track" value="<?php _e( 'Track', 'woocommerce' ); ?>" /></div>
