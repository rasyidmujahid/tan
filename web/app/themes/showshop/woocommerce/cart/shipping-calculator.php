...
<h5><?php _e( 'Shipping cost?', 'showshop' ); ?></h5>

<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

	<a href="#" class="shipping-calculator-button button tiny" id="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button tiny"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
