...
<div id="reviews">
	<div id="comments">
		...
		<?php if ( have_comments() ) : ?>
			...
			<p class="add_review"><a href="#review_form_wrapper" class="inline show_review_form button" data-rel="prettyPhoto[inline]"><?php esc_html_e( 'Add Review', 'woocommerce' ) ;?></a></p>
		
		
		<?php else : ?>

			<p class="woocommerce-noreviews">
				<?php _e( 'There are no reviews yet, would you like to <a href="#review_form_wrapper" class="inline show_review_form" data-rel="prettyPhoto[inline]" >submit yours</a>?', 'woocommerce' ) ?>
			</p>
