	...
	$main_array = array(
		...
		$main_array_2 = array(
			...
			array(
				...
				"value" => '',
				"description" => __("enter only value, units are hardcoded in pixels","showshop"),
				"admin_label" => true,
				"edit_field_class"=> "vc_col-sm-6"
			),
			...
			array(
				...
				"class" => "",
				"heading" => "",
				"description" => __("custom image width and height will override image format setting, but both width and height values must be set","showshop"),
				"param_name" => "sep_2",
				"value" => '',
				"edit_field_class"=> "vc_col-sm-12"
			),
			...
			array(
				"type" => "checkbox",
				"class" => "",
				"heading" => __("Hide text layer (title and excerpt)",'showshop'),
			...
			array(
				"type" => "checkbox",
				"class" => "",
				"heading" => __("Use text layer animation ?",'showshop'),
			...
			array(
				"type" => "dropdown",
				"class" => "",
				"heading" => __("Thumbnails format",'showshop'),
			...
			array(
				"type" => "checkbox",
				"class" => "",
				"heading" => __("Hide thumbnails navigation ?",'showshop'),
