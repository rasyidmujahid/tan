<?php
add_action( 'vc_before_init', 'map_as_single_prod_cat' );
function map_as_single_prod_cat() {
	vc_map( array(
		"name" => __("Single category products","showshop"),
		...
		"params" => array(
			...
			array(
				"type" => "separator",
				"class" => "",
				"heading" => __("Product category",'showshop'),
				"param_name" => "sep_3",
				"value" => '',
				"edit_field_class"=> "vc_col-sm-12"
			),
			...
			array(
				...
				"description" => __('select one product category to display products from.','showshop'),
				"admin_label" => true,
				"edit_field_class"=> "vc_col-sm-12"
			),
			...
			array(
				"type" => "checkbox",
				"class" => "",
				"heading" => __("Force hiding title (category name)",'showshop'),
				"param_name" => "force_hide_title",
				"value" => array( __( 'Yes, please', 'js_composer' ) => 'yes' ),
				"description" => __('by default, if no elements title set, category name will be displayed. This will force hide it. ','showshop'),
				"edit_field_class"=> "vc_col-sm-6",
			),
			...
			array(
				"type" => "checkbox",
				"class" => "",
				"heading" => __("Force hiding subtitle (category description)",'showshop'),
				"param_name" => "force_hide_subtitle",
				"value" => array( __( 'Yes, please', 'js_composer' ) => 'yes' ),
				"description" => __('by default, if no elements subtitle set, category description (if entered in Products > Categories > [category]) will be displayed. This will force hide it. ','showshop'),
				"edit_field_class"=> "vc_col-sm-6",
			),
