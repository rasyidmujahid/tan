...
class Widget_Featured_Post_Images extends WP_Widget {
	 ...
	 * Widget setup.
	 */
	function Widget_Featured_Post_Images() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'featured-image-widget', 'description' => __('A widget displaying featured content images.', 'showshop') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'featured-content-images' );

		/* Create the widget. */
		$this->WP_Widget( 'featured-content-images', __('Featured content images', 'showshop'), $widget_ops, $control_ops );
	}
					...
					<div class="anim-wrap">
						...
						<div class="item-img">
							...
							<div class="back">
								...
								<a href="<?php echo esc_attr($link); ?>" class="tip-top accent-1-light-30" title="<?php  echo the_title_attribute (array('echo' => 0)); ?>" data-tooltip><span class="icon icon-link" aria-hidden="true"></span></a>
								</div>
