...
<div id="secondary" class="widget-area large-<?php echo esc_attr($grid); ?> <?php echo esc_attr($layout);  ?>  medium-12 small-12" role="complementary">
	...
	<?php
			...
			echo '<aside class="widget"><p class="empty-sidebar">'. esc_html__("You haven't set any widget for Sidebar. Please, add some widgets or choose Full width page in theme options or page custom meta settings.",'showshop') .'</p></aside>';
